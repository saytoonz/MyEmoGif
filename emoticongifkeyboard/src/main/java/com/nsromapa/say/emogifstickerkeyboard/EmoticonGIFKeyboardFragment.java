...
//        mEmoticonSearchFragment.setEmoticonSelectListener(stickerSelectListener);
    }
    ...
    @StringDef({TAG_EMOTICON_FRAGMENT, TAG_EMOTICON_SEARCH_FRAGMENT, TAG_GIF_FRAGMENT, TAG_GIF_SEARCH_FRAGMENT, TAG_STICKER_FRAGMENT})
